...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    private void handleChangePassword() {
        ...
        // Tạo chứng chỉ xác thực (Credential) từ email và mật khẩu cũ người dùng vừa nhập.
        // Cần làm vậy vì Firebase không cho phép lấy mật khẩu hiện tại (dạng plain text) từ biến "user" do cơ chế bảo mật (băm một chiều).
        ...
        user.reauthenticate(credential).addOnCompleteListener(authTask -> {
            if (authTask.isSuccessful()) {
                ...
                user.updatePassword(newPass).addOnCompleteListener(updateTask -> {
                    // Mở lại UI sau khi Firebase xử lý xong
