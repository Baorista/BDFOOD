    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AddressAdapter(addressList, new AddressAdapter.OnAddressClickListener() {
            ...
            public void onEditClick(Address address) {
                // Mở AddressFormActivity ở chế độ SỬA bằng cách đính kèm EXTRA "ADDRESS_ID".
                // Màn hình Form sẽ dựa vào ID này để load dữ liệu cũ lên thay vì tạo mới.
    ...
    private void loadAddressesFromFirebase() {
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                // Bắt buộc phải clear() danh sách cũ trước khi add lại.
                // Vì addValueEventListener sẽ trả về TOÀN BỘ node "addresses" mỗi khi có 1 thay đổi nhỏ,
                // nếu không clear() dữ liệu sẽ bị nhân bản (duplicate) trên giao diện.
                addressList.clear();
