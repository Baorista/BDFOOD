...
// ... (Phần khai báo biến và onCreate, loadExistingData giữ nguyên như cũ)
...
/** * Ghi dữ liệu đối tượng địa chỉ vào Firebase Realtime Database.
     * * @param dbRef   Tham chiếu tới nhánh quản lý địa chỉ của User hiện tại (addresses/{uid})
     * * @param address Đối tượng Address mang dữ liệu đã được gán sẵn addressId
*/
